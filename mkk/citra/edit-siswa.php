...
$siswa = $conn->query("SELECT * FROM nilai_siswa WHERE nisn = $nisn");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, "UPDATE nilai_siswa SET name='$nama', class='$kelas', nilai= '$nilai' WHERE nisn = $nisn")) {
...
<body>
    ...
    <div class="outer">
        <h2>Daftar Nilai MKK XI RPL</h2>
        <div class="container">
            <form method="POST">
                <table class="form-table">
                    <input type="hidden" name="nisn" value="<?= $siswa[0] ?>">
                    <tr>
                        <th>NISN</th>
                        <td><input type="text" placeholder="Masukkan Nomor" value="<?= $siswa[0] ?>" disabled></td>
                    </tr>
                    <tr>
                        <th>Nama</th>
                        <td><input type="text" name="nama" placeholder="Masukkan Nama" value="<?= $siswa[1] ?>"></td>
                    </tr>
                    <tr>
                        <th>Kelas</th>
                        <td>
                    ...
                    <tr>
                        <th>Nilai</th>
                        <td><input type="number" name="nilai" placeholder="Input Nilai" value="<?= $siswa[3] ?>"></td>
                    </tr>
                    <tr>

                        <td colspan="2">
                            <input type="reset" value="Reset">
                            <button type="submit" name="simpan" value="input">Submit</button>
                        </td>
                    </tr>
                </table>
            </form>
