      ...
      <form method="POST" action="func/auth-fn.php">
        <div class="mt-4">
          <label class="block">
            ...
            <input type="text" name="username" placeholder="Masukkan username" class="input input-bordered w-full max-w-xs" />
          </label>
        </div>
        <div class="mt-4">
          <label class="block">
            <span class="text-gray-700 dark:text-white">Password</span>
            <input type="password" name="password" placeholder="Masukkan password" class="input input-bordered w-full max-w-xs" />
          </label>
        </div>
        <div class="mt-6">
